...
class ProductServiceTest {
    ...
    // @Mock :  인터페이스, 클래스에 달아주면 가짜 객체로 만들어줌
    @Mock
    ...
    void test1() {
        ...
        // productService.updateProduct(productId, requestMyPriceDto); 메소드 내부에서
        // productRepository.findById(productId)가 호출될 때, Optional.of(product)가 반환되도록 하는 것
